...
?>
<div class="cms-heading-wrapper cms-heading-layout1 text-<?php echo esc_attr($hd_content_align); ?> <?php echo esc_attr($el_class.' '.$animation_classes); ?>" style="<?php if($hd_margin){ echo 'margin-bottom: '.esc_attr($hd_margin).'px'; }  ?>">
