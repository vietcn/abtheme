...
<div class="carousel-portfolio carousel-portfolio-layout1 <?php echo esc_attr($el_class); ?>">
    ...
    <div class="grid-masonry cms-carousel owl-carousel owl-theme cms-carousel-layout2" data-margin="<?php echo esc_attr($margin); ?>" data-loop="<?php echo esc_attr($loop); ?>" data-nav="<?php echo esc_attr($nav); ?>" data-dots="<?php echo esc_attr($dots); ?>" data-autoplay="<?php echo esc_attr($autoplay); ?>" data-large-items="<?php echo esc_attr($large_items); ?>" data-medium-items="<?php echo esc_attr($medium_items); ?>" data-small-items="<?php echo esc_attr($small_items); ?>" data-xsmall-items="<?php echo esc_attr($xsmall_items); ?>">
        <?php
        if (is_array($posts)):
            foreach ($posts as $post) {
                $filter_class = abtheme_get_carousel_portfolio_term_of_post_to_class($post->ID,array_unique($tax));
                ?>
                <div class="grid-item cms-carousel-item <?php echo esc_attr($filter_class); ?>" data-category="<?php echo esc_attr($filter_class) ?>">
                    <?php
