...
vc_add_param("vc_row", array(
    "type" => "dropdown",
    "class" => "",
    "heading" => esc_html__("Theme Custom Style", 'abtheme'),
    "param_name" => "el_class",
    "value" => array(
        'None' => '',
        ...
        'Row Background Color Primary' => 'background-primary-color',
        'Row Background Color Primary Gradient' => 'background-primary-color-gradient',
